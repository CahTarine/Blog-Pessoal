	...
	OpenAPI springBlogPessoalOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("Projeto Blog Pessoal").description("Projeto Blog Pessoal - Generation Brasil")
						.version("v0.0.1")
						.license(new License().name("Camille Tarine da Silva")
								.url("https://github.com/CahTarine/Blog-Pessoal"))
						.contact(new Contact().name("Camille Tarine da Silva")
								.url("https://www.linkedin.com/in/camille-tarine/").email("camille.tarine@gmail.com")))
